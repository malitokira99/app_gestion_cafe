...
app.post("/actividades", function(req, res) {
    ...
    let registrar = "INSERT INTO actividades (nombre_actividad, nombre_realizador, jornales, insumo_utilizado, fecha_realizacion, costo_total, observaciones) VALUES (?, ?, ?, ?, ?, ?, ?)";

    conexion.query(registrar, [nombre_actividadt, nombre_realizadort, jornalest, insumo_utilizadot, fecha_realizaciont, costo_totalt, observacionest], function(error) {
        if (error) {
